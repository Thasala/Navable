  ...
  var MESSAGES = {
    en: {
      ...
      help_examples:
        ...
        + 'Voice: press Ctrl+Shift+M on Windows or Linux, or Command+Option+M on Mac, to start or stop listening. '
        ...
        + 'Keyboard shortcuts: Ctrl+Shift+J or Command+Option+J scroll down, Ctrl+Shift+L or Command+Option+L scroll up, Ctrl+Shift+N or Command+Option+N move to the next heading, Ctrl+Shift+P or Command+Option+P move to the previous heading, and Ctrl+Shift+Slash or Command+Option+Slash repeat this guide. '
        + 'Say help anytime to hear this guide again.',
      listening_help: 'Listening. Say "help" to hear example commands.',
      stopped_listening: 'Stopped listening. Press Ctrl+Shift+M on Windows or Linux, or Command+Option+M on Mac, to start again.',
      ...
      newtab_try_open: 'I did not catch that. Try: "Open YouTube", "Search for weather", "Open settings", or ask a quick question.',
      newtab_help_examples: 'Try: "Open YouTube", "Open example dot com", "Search for weather", "Open settings", "Open keyboard shortcuts", or "What is photosynthesis?"',
      newtab_page_summary: 'This is the Navable start page. You can search or open websites, start voice navigation, open settings, manage keyboard shortcuts, or ask a quick question.',
      newtab_suggestions_intro: 'Available next actions:',
      newtab_suggestion_open_site: 'Try: "Open YouTube".',
      newtab_suggestion_search: 'Try: "Search for weather".',
      newtab_suggestion_settings: 'Try: "Open settings".',
      newtab_suggestion_shortcuts: 'Try: "Open keyboard shortcuts".',
      ...
      form_field_submit_hint: 'Say submit, search, go, next, or continue when you are done.',
      ...
      form_confirmation_sensitive: 'I entered {value} for {label}. Say yes to keep it or no to change it.',
      ...
      form_email_segment_tail: 'the part after the at sign',
      form_email_segment_suffix: 'the ending after the dot',
      form_email_prompt_segment: 'I am still on {label}. Say {segment}.',
      form_email_prompt_tail: 'I am still on {label}. Say what you want after the at sign. You can say gmail dot com, yahoo dot com, outlook dot com, or another domain.',
      ...
      form_confirmation_last_field: 'That was the last field. Say finish to review, or say submit, search, go, next, or continue for the page action.',
      ...
      form_review_item_sensitive_value: '{label}: {value}.',
      form_spoken_capital: 'capital {value}',
      form_spoken_space: 'space',
    ...
    fr: {
      ...
      help_examples:
        ...
        + 'Voix : appuyez sur Ctrl+Shift+M sous Windows ou Linux, ou sur Command+Option+M sur Mac, pour activer ou arreter l ecoute. '
        ...
        + 'Raccourcis clavier : Ctrl+Shift+J ou Command+Option+J pour defiler vers le bas, Ctrl+Shift+L ou Command+Option+L pour defiler vers le haut, Ctrl+Shift+N ou Command+Option+N pour le titre suivant, Ctrl+Shift+P ou Command+Option+P pour le titre precedent, et Ctrl+Shift+Slash ou Command+Option+Slash pour repeter ce guide. '
      ...
      stopped_listening: 'Ecoute arretee. Appuyez sur Ctrl+Shift+M sous Windows ou Linux, ou sur Command+Option+M sur Mac, pour recommencer.',
      ...
      browser_back: 'Retour a la page precedente.',
      browser_forward: 'Page suivante.',
      opening_settings: 'Ouverture des parametres.',
      ...
      newtab_try_open: 'Je n ai pas compris. Essayez : "Ouvre YouTube", "Recherche la meteo", "Ouvre les parametres", ou posez une question rapide.',
      newtab_help_examples: 'Essayez : "Ouvre YouTube", "Ouvre example point com", "Recherche la meteo", "Ouvre les parametres", "Ouvre les raccourcis clavier", ou "Qu est-ce que la photosynthese ?".',
      newtab_page_summary: 'Ceci est la page de demarrage Navable. Vous pouvez rechercher ou ouvrir des sites, demarrer la navigation vocale, ouvrir les parametres, gerer les raccourcis clavier ou poser une question rapide.',
      newtab_suggestions_intro: 'Actions possibles :',
      newtab_suggestion_open_site: 'Essayez : "Ouvre YouTube".',
      newtab_suggestion_search: 'Essayez : "Recherche la meteo".',
      newtab_suggestion_settings: 'Essayez : "Ouvre les parametres".',
      newtab_suggestion_shortcuts: 'Essayez : "Ouvre les raccourcis clavier".',
      ...
      form_field_submit_hint: 'Dites soumettre, rechercher, aller, suivant ou continuer quand vous avez termine.',
      ...
      form_confirmation_sensitive: 'J ai saisi {value} pour {label}. Dites oui pour le garder ou non pour le changer.',
      ...
      form_email_segment_tail: 'la partie apres l arobase',
      form_email_segment_suffix: 'la terminaison apres le point',
      form_email_prompt_segment: 'Je reste sur {label}. Dites {segment}.',
      form_email_prompt_tail: 'Je reste sur {label}. Dites ce que vous voulez apres l arobase. Vous pouvez dire gmail point com, yahoo point com, outlook point com, ou un autre domaine.',
      ...
      form_confirmation_last_field: 'C etait le dernier champ. Dites terminer pour revoir, ou soumettre, rechercher, aller, suivant ou continuer pour l action de la page.',
      ...
      form_review_item_sensitive_value: '{label} : {value}.',
      form_spoken_capital: 'majuscule {value}',
      form_spoken_space: 'espace',
    ...
    ar: {
      ...
      help_examples:
        ...
        + 'إليك دليل سريع. '
        + 'الصوت: اضغط Ctrl+Shift+M على ويندوز أو لينكس، أو Command+Option+M على ماك، لبدء أو إيقاف الاستماع. '
        ...
        + 'اختصارات لوحة المفاتيح: Ctrl+Shift+J أو Command+Option+J للتمرير لأسفل، Ctrl+Shift+L أو Command+Option+L للتمرير لأعلى، Ctrl+Shift+N أو Command+Option+N للعنوان التالي، Ctrl+Shift+P أو Command+Option+P للعنوان السابق، و Ctrl+Shift+Slash أو Command+Option+Slash لإعادة سماع هذا الدليل. '
        + 'قل مساعدة في أي وقت لسماع هذا الدليل مرة أخرى.',
      listening_help: 'أستمع الآن. قل "مساعدة" لسماع أمثلة للأوامر.',
      stopped_listening: 'تم إيقاف الاستماع. اضغط Ctrl+Shift+M على ويندوز أو لينكس، أو Command+Option+M على ماك، للبدء من جديد.',
      ...
      browser_back: 'جارٍ الرجوع.',
      browser_forward: 'جارٍ التقدم.',
      opening_settings: 'جارٍ فتح الإعدادات.',
      ...
      newtab_try_open: 'لم أفهم ذلك. جرّب: "افتح يوتيوب"، "ابحث عن الطقس"، "افتح الإعدادات"، أو اطرح سؤالاً سريعاً.',
      newtab_help_examples: 'جرّب: "افتح يوتيوب"، "افتح example dot com"، "ابحث عن الطقس"، "افتح الإعدادات"، "افتح اختصارات لوحة المفاتيح"، أو "ما هي عملية البناء الضوئي؟".',
      newtab_page_summary: 'هذه صفحة بداية Navable. يمكنك البحث أو فتح مواقع، بدء التنقل الصوتي، فتح الإعدادات، إدارة اختصارات لوحة المفاتيح، أو طرح سؤال سريع.',
      newtab_suggestions_intro: 'إجراءات متاحة:',
      newtab_suggestion_open_site: 'جرّب: "افتح يوتيوب".',
      newtab_suggestion_search: 'جرّب: "ابحث عن الطقس".',
      newtab_suggestion_settings: 'جرّب: "افتح الإعدادات".',
      newtab_suggestion_shortcuts: 'جرّب: "افتح اختصارات لوحة المفاتيح".',
      ...
      form_field_submit_hint: 'قل أرسل، ابحث، اذهب، التالي، أو متابعة عندما تنتهي.',
      ...
      form_confirmation_sensitive: 'أدخلت {value} في {label}. قل نعم للاحتفاظ بها أو لا لتغييرها.',
      ...
      form_email_segment_tail: 'الجزء الذي بعد علامة آت',
      form_email_segment_suffix: 'النهاية التي بعد النقطة',
      form_email_prompt_segment: 'ما زلت على {label}. قل {segment}.',
      form_email_prompt_tail: 'ما زلت على {label}. قل ما تريد بعد علامة آت. يمكنك أن تقول gmail dot com أو yahoo dot com أو outlook dot com أو أي دومين آخر.',
      ...
      form_confirmation_last_field: 'كان هذا آخر حقل. قل انتهيت للمراجعة، أو قل أرسل، ابحث، اذهب، التالي، أو متابعة لتنفيذ إجراء الصفحة.',
      ...
      form_review_item_sensitive_value: '{label}: {value}.',
      form_spoken_capital: 'حرف كبير {value}',
      form_spoken_space: 'مسافة',
