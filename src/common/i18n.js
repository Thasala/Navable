(function () {
  ...
  var MESSAGES = {
    en: {
      ...
      form_field_submit_hint: 'When you are done, say review form or submit.',
      ...
      form_confirmation_last_field: 'That was the last field. Say review form or submit.',
    ...
    fr: {
      ...
      form_field_submit_hint: 'Quand vous avez termine, dites revoir le formulaire ou soumettre.',
      ...
      form_confirmation_last_field: 'C etait le dernier champ. Dites revoir le formulaire ou soumettre.',
    ...
    ar: {
      ...
      form_field_submit_hint: 'عندما تنتهي، قل راجع النموذج أو أرسل.',
      ...
      form_confirmation_last_field: 'كان هذا آخر حقل. قل راجع النموذج أو أرسل.',
