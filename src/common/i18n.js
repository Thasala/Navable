  ...
  var MESSAGES = {
    en: {
      ...
      help_examples:
        ...
        + 'Press Ctrl+Shift+M on Windows or Command+Shift+M on Mac to start or stop listening. '
        + 'Then say things like scroll down, summarize this page, open YouTube, click submit, fill out the form, or ask a question. '
        + 'Say help anytime to hear this again.',
      listening_help: 'Listening. Say "help" to hear example commands.',
      stopped_listening: 'Stopped listening. Press Ctrl+Shift+M on Windows or Command+Shift+M on Mac to start again.',
    ...
    fr: {
      ...
      help_examples:
        ...
        + 'Appuyez sur Ctrl+Shift+M sous Windows ou Command+Shift+M sur Mac pour activer ou arreter l ecoute. '
        + 'Puis dites par exemple fais defiler vers le bas, resume cette page, ouvre YouTube, clique sur soumettre, remplis le formulaire, ou posez une question. '
        + 'Dites aide a tout moment pour reentendre cela.',
      listening_help: 'J ecoute. Dites "aide" pour entendre des exemples de commandes.',
      stopped_listening: 'Ecoute arretee. Appuyez sur Ctrl+Shift+M sous Windows ou Command+Shift+M sur Mac pour recommencer.',
    ...
    ar: {
      ...
      help_examples:
        ...
        + 'اضغط Ctrl+Shift+M على ويندوز أو Command+Shift+M على ماك لبدء أو إيقاف الاستماع. '
        + 'بعدها قل مثلاً مرر إلى الأسفل، لخّص هذه الصفحة، افتح يوتيوب، اضغط إرسال، املأ النموذج، أو اسأل سؤالاً. '
        + 'قل مساعدة في أي وقت لسماع هذا مرة أخرى.',
      listening_help: 'أستمع الآن. قل "مساعدة" لسماع أمثلة للأوامر.',
      stopped_listening: 'تم إيقاف الاستماع. اضغط Ctrl+Shift+M على ويندوز أو Command+Shift+M على ماك للبدء من جديد.',
